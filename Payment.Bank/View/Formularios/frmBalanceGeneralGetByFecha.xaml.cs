...
{
    /// <summary>
    /// Interaction logic for frmBalanceGeneralGetByFecha.xaml
    /// </summary>
    public partial class frmBalanceGeneralGetByFecha : MetroWindow
    {
        //int VISTA = 1;
        //clsCiudadesBE BE = new clsCiudadesBE();
        Core.Manager db = new Core.Manager();
        public frmBalanceGeneralGetByFecha() 
        {
            InitializeComponent();
            ...
            Loaded += frmBalanceGeneralGetByFecha_Loaded;
        }




        private void frmBalanceGeneralGetByFecha_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void btnAceptar_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                frmPrintBalanceGeneralGetByFecha Informes = new frmPrintBalanceGeneralGetByFecha();
