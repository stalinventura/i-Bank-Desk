...
{
    /// <summary>
    /// Interaction logic for frmEstadoResultadosGetByFecha.xaml
    /// </summary>
    public partial class frmEstadoResultadosGetByFecha : MetroWindow
    {
        //int VISTA = 1;
        //clsCiudadesBE BE = new clsCiudadesBE();
        Core.Manager db = new Core.Manager();
        public frmEstadoResultadosGetByFecha() 
        {
            InitializeComponent();
            ...
            Loaded += frmEstadoResultadosGetByFecha_Loaded;
        }




        private void frmEstadoResultadosGetByFecha_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void btnAceptar_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                frmPrintEstadoResultadosGetByFecha Informes = new frmPrintEstadoResultadosGetByFecha();
