...
{
    [Table("DetalleNotaCreditos")]
	public class clsDetalleNotaCreditosBE: IDataErrorInfo
    {
		public clsDetalleNotaCreditosBE()
		{
		}
            ...
            get
            {
                switch (columnName)
                {
                    case "Concepto":
                        ...
                        {
                            return "Es necesario el concepto de la nota de crédito.";
                        }
                        else
                        {
                            goto default;
